...
const APP_RELEASES_API: &str =
    "https://api.github.com/repos/semantic-craft/patchbay-releases/releases/latest";
const APP_RELEASES_URL: &str = "https://github.com/semantic-craft/patchbay-releases/releases";
...
mod tests {
    ...
    #[test]
    fn app_update_routes_to_patchbay_release_surface() {
        assert_eq!(
            APP_RELEASES_API,
            "https://api.github.com/repos/semantic-craft/patchbay-releases/releases/latest"
        );
        assert_eq!(
            APP_RELEASES_URL,
            "https://github.com/semantic-craft/patchbay-releases/releases"
        );
    }
