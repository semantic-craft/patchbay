...
//! "needs attention" is the commit history's `Patchbay-Conflicts:` /
//! `Patchbay-Resolved:` trailers, replayed in topological order. The
//! hidden refs under `refs/patchbay/` only pin theirs-side objects
...
pub const REF_PRE_MERGE: &str = "refs/patchbay/pre-merge";
pub const REF_APPLYING: &str = "refs/patchbay/applying";
pub const CONFLICT_REF_PREFIX: &str = "refs/patchbay/conflict/";
pub const STAGING_REF_PREFIX: &str = "refs/patchbay/conflict-staging/";
